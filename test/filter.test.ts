...
const sample = [
  { id: "1", priority: "low", done: false, ref: "", title: "", createdAt: "" },
  { id: "2", priority: "high", done: false, ref: "", title: "", createdAt: "" },
  { id: "3", priority: "normal", done: true, ref: "", title: "", createdAt: "" },
];
...
describe("filter", () => {
  ...
  it("sortTodos is stable within a priority tier", () => {
    const tie = [
      { id: "a", priority: "normal", done: false, ref: "", title: "", createdAt: "" },
      { id: "b", priority: "normal", done: false, ref: "", title: "", createdAt: "" },
    ];
