...
const sample: Todo[] = [
  { id: "1", ref: "T-ABCDEF", title: "", priority: "low", done: false, createdAt: "" },
  { id: "2", ref: "T-BCDEFG", title: "", priority: "high", done: false, createdAt: "" },
  { id: "3", ref: "T-CDEFGH", title: "", priority: "normal", done: true, createdAt: "" },
];
...
describe("filter", () => {
  ...
  it("sortTodos is stable within a priority tier", () => {
    const tie = [
      { id: "a", ref: "T-ABCDEF", title: "", priority: "normal", done: false, createdAt: "" },
      { id: "b", ref: "T-BCDEFG", title: "", priority: "normal", done: false, createdAt: "" },
    ];
